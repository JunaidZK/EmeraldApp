                    ...
                    child: Padding(
                        ...
                        child: Column(
                            ...
                            children: [
                              AppTextSemiBold(
                                  text: localization
                                      .translate("Area of Expertise"),
                                  fontFamily: FontFamily.hermann,
                                  color: Theme.of(context).primaryColor,
                                  fontSize: 16.sp),
                              AppDropDownTextfield<Category>(
                                  placeholder: localization
                                      .translate("Select Area of Expertise"),
                                  placeholderColor:
                                      Theme.of(context).primaryColor,
                                  fontFamily: FontFamily.raleway,
                                  fontSize: 14.5.sp,
                                  outlineBorder: UnderlineInputBorder(
                              ...
                              Column(
                                  ...
                                  children: [
                                    AppTextSemiBold(
                                        text: localization.translate("Service"),
                                        fontFamily: FontFamily.hermann,
                                        color: Theme.of(context).primaryColor,
                                        fontSize: 16.sp),
                                        ...
                                        outlineBorder: UnderlineInputBorder(
                                            borderSide: BorderSide(
                                                color: Theme.of(context)
                                                    .primaryColor)),
                                        value: value
                                            .selectedService, // Ensure the value is correctly assigned
                                        items: value.filteredServices
                                            .map((service) {
                              ...
                              Row(children: [
                                Expanded(
                                    child: Column(
                                      ...
                                      AppTextSemiBold(
                                          text: localization
                                              .translate("Pre-define Price"),
                                          fontSize: 16.sp,
                                          color:
                                              Theme.of(context).primaryColor),
                                      AppTextField(
                                          textController:
                                              value.predefinePriceController,
                                          prefixText: "AED\t\t",
                                ...
                                Expanded(
                                    child: Column(
                                      ...
                                      AppTextSemiBold(
                                          text: localization
                                              .translate("Additional Price"),
                                          fontSize: 16.sp,
                                          color:
                                              Theme.of(context).primaryColor),
                                      AppTextField(
                                          textController:
                                              value.additonalPriceController,
                                          focusedBorder: OutlineInputBorder(
                                              borderRadius:
                                                  BorderRadius.circular(8.0),
                                              borderSide: const BorderSide(
                              ...
                              SizedBox(height: 1.h),
                              Column(
                                  children: value.serviceDocuments
                                      .asMap()
                                      .entries
                                      .map((entry) {
                                int index = entry.key;
                                ...
                                return ListTile(
                                    ...
                                    trailing: IconButton(
                                        icon: const Icon(Icons.delete,
                                            color: redColor),
                                        onPressed: () =>
                                            value.deleteDocument(index)));
                              }).toList()),
                              SizedBox(height: 1.h),
                              AppTextSemiBold(
                                  text: localization
                                      .translate("Attached Photos/Videos"),
                                  fontSize: 16.sp,
                                  color: Theme.of(context).primaryColor),
                              SizedBox(height: 1.5.h),
                              Wrap(
                                  ...
                                  children: [
                                    if (value.portfolio.isNotEmpty) ...[
                                      for (int index = 0;
                                          index < value.portfolio.length;
                                          index++)
                                        Stack(
                                            alignment: Alignment.topRight,
                                            children: [
                                              AppNetworkImage(
                                                  image: value.portfolio[index],
                                                  width: 25.w,
                                                  height: 12.h,
                                                  fit: BoxFit.contain),
                                              GestureDetector(
                                    ...
                                    GestureDetector(
                                        onTap: () async =>
                                            await value.addPortfolio(),
                                        child: AppDottedUpload(
                                            svg: roundedAdd,
                                            padding: EdgeInsets.only(
                                                right: localization.locale
                                                            .languageCode ==
                                                        "en"
                                                    ? 65.w
                                                    : 0.w,
                                                left: localization.locale
                                                            .languageCode ==
                                                        "ar"
                                                    ? 65.w
                                                    : 0.w),
                              ...
                              Center(
                                  child: App3DButton(
                                      ...
                                      tap: () async {
                                        final bool response =
                                            await value.createNewUserService();
                                        if (response) {
                                          Navigator.pop(context);
                                        }
                                      },
