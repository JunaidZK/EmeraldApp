...
import 'package:emerald_beauty/views/main_home/profile_tab/policies_and_legal_info/privacy_policy/privacy_policy_provider.dart';
...
class PrivacyPolicyView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      ...
      child:
          Consumer<PrivacyPolicyProvider>(builder: (context, provider, child) {
        return Stack(
          children: [
            SafeArea(
                top: false,
                ...
                child: Scaffold(
                  appBar: appBar(
                    context,
                    appBarheight: 8.h,
                    title: localization!.translate("PRIVACY POLICY"),
                  ...
                  body: provider.privacyPolicy?.data?.content != null
                          ...
                          child: Padding(
                            ...
                            child: Html(
                              data: localization.locale.languageCode == "en"
                                  ? provider.privacyPolicy!.data!.content
                                  : provider.privacyPolicy!.data!.arabicContent,
                              style: {
                                "h1": Style(
                                  fontSize:
