...
import 'package:emerald_beauty/views/main_home/profile_tab/policies_and_legal_info/terms_and_conditions/terms_conditions_provider.dart';
import 'package:flutter/material.dart';
import 'package:flutter_html/flutter_html.dart';
import 'package:provider/provider.dart';
import 'package:responsive_sizer/responsive_sizer.dart';

class TermsConditionsViews extends StatelessWidget {
  const TermsConditionsViews({super.key});
              ...
              SafeArea(
                ...
                child: Scaffold(
                  appBar: appBar(
                    context,
                    appBarheight: 8.h,
                    title: localization!.translate("TERMS AND CONDITIONS"),
                  ...
                  body: provider.termsNconditions?.data?.content != null
                          ...
                          child: Padding(
                            ...
                            child: Html(
                              data: localization.locale.languageCode == "en"
                                  ? provider.termsNconditions!.data!.content
                                  : provider
                                      .termsNconditions!.data!.arabicContent,
                              style: {
                                "h1": Style(
                                  fontSize:
